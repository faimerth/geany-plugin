...
./tmp/Faimerth_api.o:Faimerth_api.c Faimerth_core.h Faimerth_config.h Faimerth_gui.h ./tmp
	gcc -c -O3 Faimerth_api.c $(DEBUG) -o ./tmp/Faimerth_api.o -flto -fPIC $$(pkg-config --cflags geany) -I "$$HOME/FDTH/CCE/Headers" -w

./tmp/Faimerth_core.o:Faimerth_core.c ./tmp
	gcc -c -O3 Faimerth_core.c $(DEBUG) -DNOMAIN -flto -fPIC -o ./tmp/Faimerth_core.o $(COMPILE_OPTIONS)
